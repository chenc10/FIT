...
#define TPTD_CLIENT_TO_SERVER	1
#define TPTD_SERVER_TO_CLIENT	2
#define TPTD_NEW_FLOW			0

#define TPTD_LOOKUP_UNREVERSE		0
#define TPTD_LOOKUP_REVERSE		1

#define TPTD_LOOKUP_WRITE		0
#define TPTD_LOOKUP_READONLY	1
...
extern char nids_pcap_file[128];
extern char nids_prefix_output[128];
# ifdef __cplusplus
}
# endif
